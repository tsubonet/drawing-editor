...
export const RotateHandler: React.FC<RectProps> = ({
  ...
  return (
    ...
    >
      ...
      ></line>
      <path
        d="M11.35,7.6A5.06,5.06,0,0,1,1.66,5.86m.42-2.42A5,5,0,0,1,6.72.38a5.1,5.1,0,0,1,5.07,5.13"
        fill="none"
        stroke="#2488fd"
        strokeLinecap="round"
      ...
      ></path>
      <polyline
        points="0.38 6.76 1.08 5.86 1.78 4.95 2.48 5.86 3.18 6.76"
        fill="none"
        stroke="#2488fd"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      ></polyline>
      <polyline
        points="13.16 4.45 12.46 5.36 11.76 6.26 11.05 5.36 10.35 4.45"
        fill="none"
        stroke="#2488fd"
        strokeLinecap="round"
        strokeLinejoin="round"
